...
git clone --depth=1 https://github.com/davincirr/docker-odoo-17-CE $DESTINATION
...
echo 'Started Odoo @ http://localhost:'$PORT' | Master Password: control@odoo17+. | Live chat port: '$CHAT
